  ...
  super_admin: [
    {
      ...
      icon: <Users className="w-8 h-8 text-[#DBC078]" />,
      roles: ['super_admin'],
    },
    {
      id: 'import',
      ...
      icon: <Upload className="w-8 h-8 text-[#DBC078]" />,
      roles: ['super_admin'],
    },
    {
      id: 'users',
      ...
      icon: <UserPlus className="w-8 h-8 text-[#DBC078]" />,
      roles: ['super_admin'],
    },
    {
      id: 'matching',
      ...
      icon: <BrainCircuit className="w-8 h-8 text-[#DBC078]" />,
      roles: ['super_admin'],
    },
  ],
  hr: [
    {
      ...
      icon: <Building2 className="w-8 h-8 text-[#DBC078]" />,
      roles: ['hr'],
    },
    {
      id: 'dashboard',
      ...
      icon: <Target className="w-8 h-8 text-[#DBC078]" />,
      roles: ['hr'],
    },
    {
      id: 'pairs',
  ...
  mentor: [
    {
      ...
      icon: <GraduationCap className="w-8 h-8 text-[#DBC078]" />,
      roles: ['mentor'],
    },
    {
      id: 'profile',
      ...
      icon: <UserCircle className="w-8 h-8 text-[#DBC078]" />,
      roles: ['mentor'],
    },
    {
      id: 'teams',
      ...
      icon: <Microsoft className="w-8 h-8 text-[#DBC078]" />,
      roles: ['mentor'],
    },
  ],
  mentee: [
    ...
    },
    {
      ...
      icon: <MessageSquare className="w-8 h-8 text-[#DBC078]" />,
      roles: ['mentee'],
    },
  ],
};

export default function OnboardingFlow({ role, theme, language }) {
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-4 py-2 rounded-lg border ${theme === 'dark' ? 'bg-white/5 border-white/10 text-white' : 'bg-white border-slate-300 text-slate-900'} focus:ring-2 focus:ring-[#DBC078] focus:border-transparent transition-colors duration-200`}
              />
            </div>
          ...
          <div className="space-y-6">
            <div className={`p-6 rounded-lg ${theme === 'dark' ? 'bg-white/5' : 'bg-slate-50'}`}>
              <div className="flex items-center space-x-4 mb-4">
                <Microsoft className="w-8 h-8 text-[#DBC078]" />
              ...
              <button className="w-full px-6 py-3 bg-[#464EB8] text-white rounded-lg hover:bg-[#3940A2] transition-colors duration-200 flex items-center justify-center space-x-2">
          ...
          <AnimatePresence initial={false} custom={1}>
            ...
            >
              ...
              <div className="mt-8 flex justify-end">
                <button
                  onClick={handleNext}
                  className="group relative px-6 py-3 bg-[#DBC078] text-white rounded-lg hover:bg-[#c5ad6a] transition-all duration-200"
                >
